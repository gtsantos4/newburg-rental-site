...
export const PROPERTY_CONFIG = {
  name: '[REPLACE: Your Property Name]',
  tagline: '[REPLACE: Fully Furnished Rooms · All Utilities Included · Minutes from Downtown]',
  address: '[REPLACE: 123 Main Street, City, ST 12345]',
...
The home features a spacious shared kitchen, in-unit laundry, off-street parking, and a private backyard. Each room is thoughtfully furnished with a queen bed, desk, dresser, and closet. All utilities, high-speed WiFi, and basic supplies are included in the rent — just bring your suitcase.]`,
  ...
  nearbyPlaces: [
    { name: '[REPLACE: City General Hospital]', distance: '0.5 miles', type: 'hospital' },
    { name: '[REPLACE: Metro Station]', distance: '0.3 miles', type: 'transit' },
    { name: '[REPLACE: Whole Foods]', distance: '0.8 miles', type: 'grocery' },
    { name: '[REPLACE: Downtown District]', distance: '1.2 miles', type: 'entertainment' },
